...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        <footer class="bg-white">
            ...
            <div class="px-4 py-12 mx-auto space-y-8 overflow-hidden max-w-7xl sm:px-6 lg:px-8">
                <nav class="flex flex-wrap justify-center -mx-5 -my-2" aria-label="Footer">
                    ...
                    <div class="px-5 py-2">
                        <a href="{{ config('nova.path') }}" class="text-base text-gray-500 hover:text-gray-900">
                            Admin
                        </a>
                    </div>
                </nav>
